...
dataset = pd.read_csv("../datasets/jena_climate_2009_2016.csv")
...
EPOCHS = 10
CALLBACKS = [
    ModelCheckpoint("../model_weights/lstm_temperature_forecasting_model.h5")
]

# Splits dataset into train, test split with 80/10/10 split as default
def prepare_train_validation_test_split(data, train_size=0.8, val_size=0.1):
...
MODEL_PATH = "../model_weights/lstm_temperature_forecasting_model.h5"
